...
from hex_to_rgb import hex_to_rgb  # Falls notwendig, andernfalls löschen
...
class Proc:
    ...
    def LC(self):
        ...
        # Versuche, das LED-Gerät zu setzen
        try:
    ...
    def admin(self):
        ...
        # Führe den entsprechenden Admin-Befehl aus
    ...
    def get_version(self):
        ...
        if self.data['payload'] == 'all':
            ...
            return Version.get(self.data['payload'], 'Version nicht gefunden.') # type: ignore
...
def run(json_string):
    try:
        # Direktes Laden der JSON-Daten ohne temporäre Datei
        data = json.loads(json_string)
        order = data['Type']
        
        # Instanz der Proc-Klasse erstellen und den entsprechenden Befehl aufrufen
